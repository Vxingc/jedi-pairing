...
func main() {
	...
	fmt.Println("[*] Mode: 10D Query-Independent Offline Fixed-Order Parent Supplement + Full Parallel Protocol")
	...
	fmt.Printf("Architecture: 10D Query-Independent Offline M-HIBE + Full Parallel Protocol + ZK-Accumulator\n")
