...
func main() {
	...
	fmt.Println("[*] Mode: 5D Fixed-Order Parent Supplement Cover + Full Parallel Extraction/M-HIBE + ZK-Accumulator (Authenticity)")
	...
	fmt.Printf("4. Cover Strategy: parallel fixed-order parent extraction + parallel query intersection + parallel delegation\n")
	...
	fmt.Printf("Architecture: 5D Full-Parallel M-HIBE Fixed-Order Parent Supplement Cover + ZK-Accumulator (Lightweight Auth)\n")
