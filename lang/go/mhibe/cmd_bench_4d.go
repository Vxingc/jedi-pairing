...
func main() {
	...
	fmt.Println("[*] Mode: 4D Fixed-Order Parent Supplement Cover + ZK-Accumulator (Authenticity)")
	...
	fmt.Printf("4. Cover Strategy: offline fixed-order parent empty regions + online query intersection/delegation\n")
	...
	fmt.Printf("Architecture: 4D M-HIBE Fixed-Order Parent Supplement Cover + ZK-Accumulator (Lightweight Auth)\n")
