...
func main() {
	...
	fmt.Println("[*] Mode: 5D Fixed-Order Parent Supplement Cover + Parallel M-HIBE + ZK-Accumulator (Authenticity)")
	...
	// ========================================================
	fmt.Println("\n=== ENGINE A: 5D M-HIBE FIXED-ORDER PARENT SUPPLEMENT (Confidentiality & Access Control) ===")
	...
	fmt.Printf("Architecture: 5D Parallel M-HIBE Fixed-Order Parent Supplement Cover + ZK-Accumulator (Lightweight Auth)\n")
