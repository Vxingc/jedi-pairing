...
var DimBitLengths = [NumDims]int{12, 4, 6, 4, 4}
...
var DimExpandAsParent = [NumDims]bool{true, true, false, false, false}
...
func main() {
	...
	dimBitsFlag := flag.String("dim-bits", "12,4,6,4,4", "comma-separated bit widths for each of the NumDims dimensions (e.g. \"12,4,6,4\")")
