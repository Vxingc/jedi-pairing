...
func main() {
	...
	fmt.Println("[*] Mode: 2D X-Parent Supplement Cover + ZK-Accumulator (Authenticity)")
	...
	fmt.Printf("4. Cover Strategy: offline global empty parents + online query intersection/delegation\n")
	...
	fmt.Printf("Architecture: 2D M-HIBE X-Parent Supplement Cover + ZK-Accumulator (Lightweight Auth)\n")
