...
var DimBitLengths = [NumDims]int{12, 4}
...
var DimExpandAsParent = [NumDims]bool{true, true}
...
func main() {
	...
	dimBitsFlag := flag.String("dim-bits", "12,4", "comma-separated bit widths for each of the NumDims dimensions (e.g. \"12,4,6,4\")")
	expandParentDimsFlag := flag.String("expand-parent-dims", "0",
