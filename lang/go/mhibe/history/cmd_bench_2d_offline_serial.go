...
func main() {
	...
	fmt.Println("[*] Mode: 2D Query-Independent Offline X-Parent Supplement + Optimized Serial Online Cover")
	...
	fmt.Printf("Architecture: 2D Query-Independent Offline M-HIBE X-Parent Supplement + Optimized Serial Online Cover + ZK-Accumulator\n")
	fmt.Printf("Total Setup Time: %.2f ms\n", setupMs+offlineEmptyMs+zkCommitMs)
