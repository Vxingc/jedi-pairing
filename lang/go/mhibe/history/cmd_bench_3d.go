...
func main() {
	...
	fmt.Println("[*] Mode: 3D XY-Parent Supplement Cover + ZK-Accumulator (Authenticity)")
	...
	fmt.Printf("4. Cover Strategy: offline global (X,Y)-parent empty-Z regions + online query intersection/delegation\n")
	...
	fmt.Printf("Architecture: 3D M-HIBE XY-Parent Supplement Cover + ZK-Accumulator (Lightweight Auth)\n")
