...
func main() {
	...
	fmt.Println("[*] Mode: 4D Query-Independent Offline Fixed-Order Parent Supplement Protocol")
	...
	fmt.Printf("Architecture: 4D Query-Independent Offline M-HIBE + Optimized Serial Protocol + ZK-Accumulator\n")
