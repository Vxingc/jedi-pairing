...
func main() {
	...
	fmt.Println("[*] Mode: 4D Fixed-Order Parent Supplement Cover + Full Parallel Extraction/M-HIBE + ZK-Accumulator (Authenticity)")
	...
	fmt.Printf("Architecture: 4D Full-Parallel M-HIBE Fixed-Order Parent Supplement Cover + ZK-Accumulator (Lightweight Auth)\n")
