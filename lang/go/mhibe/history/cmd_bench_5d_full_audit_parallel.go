...
func main() {
	...
	fmt.Println("[*] Mode: 5D Query-Independent Offline Fixed-Order Parent Supplement + Full Parallel Protocol")
	...
	fmt.Printf("Architecture: 5D Query-Independent Offline M-HIBE + Full Parallel Protocol + ZK-Accumulator\n")
