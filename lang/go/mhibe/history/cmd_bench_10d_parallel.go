...
func main() {
	...
	fmt.Println("[*] Mode: 10D Fixed-Order Parent Supplement Cover + Parallel M-HIBE + ZK-Accumulator (Authenticity)")
	...
	fmt.Printf("Architecture: 10D Parallel M-HIBE Fixed-Order Parent Supplement Cover + ZK-Accumulator (Lightweight Auth)\n")
